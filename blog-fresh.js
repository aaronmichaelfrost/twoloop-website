            ...
            const workingTestStructure = `
                ...
                <div class="changelog-items">
                    <ul>
                        ...
                        <li>bug fix â€“ you cannot consume med-kits if they are not in your inventory</li>
                        <li>added dev option to force island biome in Fractium Editor Config window</li>
                        <li>workflow Improvement â€“ made flat world use main gameplay scene to share UI objects</li>
                    </ul>
                </div>
